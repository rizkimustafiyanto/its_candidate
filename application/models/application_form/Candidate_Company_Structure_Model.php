...
class Candidate_Company_Structure_Model extends CI_Model
{
    function GetCandidateCompanyStructure($candidate_company_structure_parameter)
    {
    ...
    function InsertCandidateCompanyStructure($candidate_company_structure_parameter)
    {
        $procedure = "call usp_gm_candidate_company_structure_insert(?,?,?,?,?,?,?,?)";
        $result = $this->db->query($procedure, $candidate_company_structure_parameter);
