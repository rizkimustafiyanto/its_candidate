...
class paidleavedetailreport_controller extends BaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('reportdetail/paidleavedetailreport_model');
    ...
    public function index()
    {
        ...
        $this->loadViews("reportdetail/paidleavedetailreport", $this->global, NULL, NULL);
    }

    function GetPaidLeaveDetailReport()
    {
        ...
        if ($this->session->userdata('role_id') == '1' || $this->session->userdata('role_id') == '5') {
            ...
            $paidleavereport_parameter = array(
                // 'p_employee_paid_leave_id' => 0, 
                'p_employee_id' => 0,
                // 'p_paid_leave_id' => 0, 
            ...
            $data['PaidLeaveReportListRecords'] = $this->paidleavedetailreport_model->GetPaidLeaveReport2($paidleavereport_parameter);
        }
        ...
        $this->loadViews("reportdetail/paidleavedetailreport", $this->global, $data, NULL);
    }

    function GetDefaultPaidLeaveDetailReport()
    {
        if ($this->session->userdata('role_id') == '1' || $this->session->userdata('role_id') == '5') {
            ...
            $paidleavereport_parameter = array('p_employee_paid_leave_id' => 0, 'p_employee_id' => 0, 'p_paid_leave_id' => 0, 'p_date_1' => 0, 'p_date_2' => 0, 'p_flag' => 0);
            $data['PaidLeaveReportListRecords'] = $this->paidleavedetailreport_model->GetPaidLeaveReport($paidleavereport_parameter);
        }
        ...
        if ($this->session->userdata('role_id') == '2') {
            ...
            $paidleavereport_parameter = array(
                'p_employee_id' => $employee_id,
                'p_company_id' => $company_id, 'p_company_brand_id' => $data['companybrandid'], 'p_date_1' => 0, 'p_date_2' => 0, 'p_flag' => 1
            );
            $data['PaidLeaveReportListRecords'] = $this->paidleavedetailreport_model->GetPaidLeaveReport2($paidleavereport_parameter);
        }
