...
class overtimedetailreport_controller extends BaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('reportdetail/overtimedetailreport_model');
    ...
    public function index()
    {
        ...
        $this->loadViews("reportdetail/overtimedetailreport", $this->global, NULL, NULL);
    }

    function GetOvertimeDetailReport()
    {
        ...
        if ($this->session->userdata('role_id') == '1' || $this->session->userdata('role_id') == '5') {
            ...
            $data['OvertimeReportListRecords'] = $this->overtimedetailreport_model->GetOvertimeReport2($overtimereport_parameter);
        }
        ...
        $this->loadViews("reportdetail/overtimedetailreport", $this->global, $data, NULL);
    }

    function GetDefaultOvertimeDetailReport()
    {
        ...
        if ($this->session->userdata('role_id') == '1' || $this->session->userdata('role_id') == '5') {
            ...
            $overtimereport_parameter = array(
                'p_overtime_id' => 0,
                'p_employee_id' => 0, 'p_date_1' => 0, 'p_date_2' => 0, 'p_flag' => 0
            );
            $data['OvertimeReportListRecords'] = $this->overtimedetailreport_model->GetOvertimeReport($overtimereport_parameter);
        }
