...
class cuttingpaidleavedatetime_controller extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->loadViews("cuttingpaidleavedatetime/cuttingpaidleavedatetime", $this->global, NULL, NULL);
    }

    function GetCuttingPaidLeaveDateTime()
    {
    ...
    function InsertCuttingPaidLeaveDateTime()
    {
        ...
        redirect('CuttingPaidLeaveDetail/' . $employee_paid_leave_id . '/' . $paid_leave_id . '/' . $employee_id);
    }

    function DeleteCuttingPaidLeaveDateTime($employee_paid_leave_datetime_id, $employee_paid_leave_id, $paid_leave_id, $employee_id)
    {
