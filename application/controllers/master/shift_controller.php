...
class shift_controller extends BaseController
{
    ...
    {
        $shift_parameter = array('p_shift_details_id' => 0, 'p_shift_id' => $shift_id, 'p_flag' => 0);
    ...
    function UpdateShift()
    {
        ...
        $shift_parameter = array($shift_id, $shift_name, $description, $change_user_id, $record_status);
