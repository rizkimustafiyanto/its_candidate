...
class company_branch_controller extends BaseController
{
    ...
    function InsertCompanyBranch()
    {
        ...
        $company_branch_parameter = array($company_branch_id, $company_id, $company_branch_name, $longitude, $latitude, $change_no, $creation_user_id, $change_user_id, $record_status);
    ...
    function UpdateCompanyBranch()
    {
        ...
        $change_user_id = $this->session->userdata('employee_id');
        $record_status = "A";
        $company_branch_parameter = array($company_branch_id, $company_branch_name, $company_id, $longitude, $latitude, $change_user_id, $record_status);
