                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody id="details">
                                    <?php
                                    if (!empty($MenuLPPDApprovalListRecords)) {
                                        foreach ($MenuLPPDApprovalListRecords as $record) {
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php if ($record->lppd_status_id == 'ST-001') { ?>
                                                        <a id="btnSelect" class="btn btn-xs btn-primary" href="<?php echo base_url() . 'SPPDDetail/' . $record->lppd_id . '/' . $record->zone_type; ?>"><i class="fa fa-pen"></i></a>
                                                        <a id="btnDelete" class="btn btn-xs btn-danger tombol-hapus" href="<?php echo base_url() . 'DeleteSPPD/' . $record->lppd_id; ?>"><i class="fa fa-trash"></i></a>
                                                    <?php } else { ?>
