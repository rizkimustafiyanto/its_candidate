                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <?php if ($this->session->userdata('role_id') == '1' || $this->session->userdata('role_id') == '5') { ?>
                                        <form role="form" action="<?php echo base_url() ?>OvertimeDetailReport" method="post">
                                            <div class="col-sm-12">
                                                <div class="row ">
                                                    <div class="row-sm-3">
                                                        <label>Company</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="row-sm-1">
                                                            ...
                                                            <button class="btn btn-secondary">
                                                                <a style="text-decoration:none;color:white" href="<?php echo base_url() ?>GetDefaultOvertimeDetailReport">Reset</a>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
