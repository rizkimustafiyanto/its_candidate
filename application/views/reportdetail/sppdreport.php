                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <?php if ($this->session->userdata('role_id') == '1' || $this->session->userdata('role_id') == '5') { ?>
                                        <form role="form" action="<?php echo base_url() ?>SPPDReport" method="post">
                                            <div class="col-sm-12">
                                                <div class="row ">
                                                    <div class="row-sm-3">
                                                        <label>Company</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="row-sm-1">
                                                            ...
                                                            <button class="btn btn-secondary">
                                                                <a style="text-decoration:none;color:white" href="<?php echo base_url() ?>GetDefaultSPPDReport">Reset</a>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="sppd_report" class="table table-bordered table-striped table-responsive">
                                ...
                                <tbody>
                                    <?php
                                    if (!empty($SPPDReportRecords)) {
                                        foreach ($SPPDReportRecords as $record) {
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $record->sppd_date_time ?></td>
                                                <td><?php echo $record->tujuan_kota_id ?></td>
                                                <td><?php echo $record->creation_datetime ?></td>
                                                <td>
                                                    <?php if ($record->sppd_status_id == 'ST-001') { ?>
                                                        <a class="badge badge-pill badge-secondary float"> <?= $record->sppd_status_name; ?></a>
                                                    <?php } else if ($record->sppd_status_id == 'ST-002') { ?>
                                                        <a class="badge badge-pill badge-success float"> <?= $record->sppd_status_name; ?></a>
                                                    <?php } else if ($record->sppd_status_id == 'ST-004') { ?>
                                                        <a class="badge badge-pill badge-danger float"> <?= $record->sppd_status_name; ?></a>
                                                    <?php } else if ($record->sppd_status_id == 'ST-005') { ?>
                                                        <a class="badge badge-pill badge-primary float"> <?= $record->sppd_status_name; ?></a>
                                                    <?php } else { ?>
                                                        <a class="badge badge-pill badge-warning float"> <?= $record->sppd_status_name; ?></a>
                                                    <?php }  ?>
                                                </td>
