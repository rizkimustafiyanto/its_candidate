                ...
                <div class="col-12">
                    <div class="row mb-1">
                        ...
                        <div class="col-lg-12">
                            <ol class="breadcrumb float-sm-left" style="font-size: small; padding-top: 10px;">
                                ...
                                <li class="breadcrumb-item">Pemotongan Cuti</li>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="col-xs-12 text-left">
                                <a href="<?php echo base_url() ?>CuttingPaidLeave" class="btn btn-md btn-circle btn-primary">
                        ...
                        <div class="col-sm-7">
                            <div class="col-xs-12 text-right">
                                <?php if ($paid_leave_status_id == 'ST-001') { ?>
                                    <button type=" button" class="btn btn-md btn-primary" id="btnUpdateCuttingPaidLeave">
                                        <i class="fa fa-edit"></i> Update
                                    </button>
                                    <?php if (!empty($PaidLeaveDateTimeRecords)) { ?>
                                        <button type=" button" class="btn btn-md btn-success show-loading" id="btnSubmitCuttingPaidLeave">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <strong>
                                        <h4 class="card-title"><b>Edit Pemotongan Cuti</b></h4>
                                    </strong>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select data-width="100%" class="form-control select2bs4 paid_leave_name2" id="paid_leave_name2" name="paid_leave_name2" disabled>
                                                    <?php
                        ...
                        <div class="col-md-12">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if ($paid_leave_status_id == 'ST-001') { ?>
                                                            <td class="text-center">
                                                                <a id="btnDelete" class="btn btn-xs btn-danger" href="<?php echo base_url() . 'DeleteCuttingPaidLeaveDateTime/' . $record->employee_paid_leave_datetime_id . '/' . $record->employee_paid_leave_id . '/' . $paid_leave_id . '/' . $employee_id; ?>"><i class="fa fa-trash"></i></a>
                                                            </td>
                                                        <?php } else { ?>
                                                        <?php } ?>
                                                    <?php } ?>
							...
							<?php if ($paid_leave_status_id != 'ST-001' && !empty($PaidLeaveApprovalRecords)) { ?>
                                <div class="card">
                                    <!-- card-header -->
                                    <div class="card-header">
                                        <strong>
    ...
    <div class="modal fade" id="modal-input-datetime-paidleave">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form role="form" action="<?php echo base_url() ?>InsertCuttingPaidLeaveDateTime" method="post">
...
<script>
    ...
    $(document).ready(function() {
        $("#btnSubmitCuttingPaidLeave").click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url() ?>SubmitCuttingPaidLeave',
                data: {
                ...
                success: function(response) {
                    if (response != null) {
                        ...
                        window.location.href = "<?php echo base_url() ?>CuttingPaidLeaveDetail/" +
    ...
    $(document).ready(function() {
        $("#btnUpdateCuttingPaidLeave").click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url() ?>UpdateCuttingPaidLeave',
                data: {
                    employee_paid_leave_id: employeepaidleaveid,
                    employee_id: employeeid,
                    company_brand_id: companybrandid,
